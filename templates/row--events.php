			...
			<div class="row">
				<div class="small-12 medium-6 large-6 columns"">
					<section class="unit--row-event link--unit-div">
						...
						<section class="" style="background:<?php the_field('site_colour');?>; background-image: url('images/lm-use-olives.png'); ?>;">
				...
				<?php
			        ...
			        while ($my_query->have_posts()) : $my_query->the_post(); ?>
	            		...
	            		<?php get_template_part('templates/area--home-events'); ?> 
			    	<?php endwhile; }
			    	wp_reset_query(); ?>
